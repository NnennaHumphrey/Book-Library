...
describe('createBook', () => {
    // Should return a 201 status code and the new book data on successful creation
    it('should return a 201 status code and the new book data on successful creation', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            body: {
                title: 'Test Book',
