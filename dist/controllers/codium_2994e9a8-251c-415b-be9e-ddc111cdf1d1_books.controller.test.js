...
describe('createBook', () => {
    // Should handle and throw any non-ZodError exceptions thrown by the 'validateBook' function
    it('should handle and throw any non-ZodError exceptions thrown by the validateBook function', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            body: {
                title: 'Test Book',
        ...
        books_validation_1.validateBook = jest.fn(() => {
