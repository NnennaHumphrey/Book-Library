...
describe('createBook', () => {
    // Should handle and throw any errors thrown during book creation
    it('should handle and throw any errors thrown during book creation', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            body: {
                title: 'Test Book',
        ...
        books_model_1.Book.create = jest.fn(() => {
