...
describe('createBook', () => {
    // Should retrieve the user ID from the request and associate it with the new book
    it('should retrieve the user ID from the request and associate it with the new book', () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            body: {
                title: 'Test Book',
